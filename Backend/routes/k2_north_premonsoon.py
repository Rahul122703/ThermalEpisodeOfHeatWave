...
MODEL_PATH = os.path.join(BASE_DIR, "models", "k2_north_premonsoon.h5")
...
@north_premonsoon_bp.route("/summary", methods=["GET"])
def model_summary():
...
@north_premonsoon_bp.route("/predict", methods=["GET"])
def predict():
